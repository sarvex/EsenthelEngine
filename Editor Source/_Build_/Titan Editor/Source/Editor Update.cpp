...
void DrawInstall()
{
   D.clear(BackgroundColor());
   TextStyleParams ts;
   ts.size=0.055f; D.text(ts, 0, D.h()-0.05f, InstallIO.visible() ? "Please select path for " ENGINE_NAME " installation" : "Installing to");
