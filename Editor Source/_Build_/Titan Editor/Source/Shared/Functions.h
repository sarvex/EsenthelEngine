...
template<typename TYPE> bool UndoEqual(TimeStamp &time, C TimeStamp &src_time, TYPE &data, C TYPE &src_data);
template<typename TYPE> bool UndoMem(TimeStamp &time, C TimeStamp &src_time, TYPE &data, C TYPE &src_data);
