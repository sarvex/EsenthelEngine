...
/******************************************************************************/
   EditEnv::EditEnv() : sun_id(UIDZero), star_id(UIDZero), skybox_id(UIDZero) {REPAO(cloud_id).zero();}
   bool EditEnv::newer(C EditEnv &src)C
   {
      return
   ...
   || bloom_on_time>src.bloom_on_time
   ...
   bool EditEnv::equal(C EditEnv &src)C
   {
      return
      ambient_on_time==src.ambient_on_time && ambient_color_time==src.ambient_color_time && night_shade_color_time==src.night_shade_color_time
   && bloom_on_time==src.bloom_on_time
   ...
   void EditEnv::newData()
   {
      ambient_on_time++; ambient_color_time++; night_shade_color_time++;
      bloom_on_time++; bloom_original_time++; bloom_scale_time++; bloom_cut_time++; bloom_glow_time++;
   ...
   bool EditEnv::sync(C EditEnv &src)
   {
      bool changed=false;
      ...
      changed|=Sync(bloom_glow_time, src.bloom_glow_time, bloom.glow, src.bloom.glow);
      ...
      changed|=Sync(fog_color_time, src.fog_color_time, fog.color_s, src.fog.color_s);
      ...
      changed|=Sync(sky_atmospheric_horizon_color_time, src.sky_atmospheric_horizon_color_time, sky.atmospheric_horizon_color_s, src.sky.atmospheric_horizon_color_s);
      changed|=Sync(sky_atmospheric_sky_color_time, src.sky_atmospheric_sky_color_time, sky.atmospheric_sky_color_s, src.sky.atmospheric_sky_color_s);
   ...
   bool EditEnv::undo(C EditEnv &src)
   {
      bool changed=false;
      ...
      changed|=Undo(bloom_glow_time, src.bloom_glow_time, bloom.glow, src.bloom.glow);
      ...
      changed|=Undo(fog_color_time, src.fog_color_time, fog.color_s, src.fog.color_s);
      ...
      changed|=Undo(sky_atmospheric_horizon_color_time, src.sky_atmospheric_horizon_color_time, sky.atmospheric_horizon_color_s, src.sky.atmospheric_horizon_color_s);
      changed|=Undo(sky_atmospheric_sky_color_time, src.sky_atmospheric_sky_color_time, sky.atmospheric_sky_color_s, src.sky.atmospheric_sky_color_s);
   ...
   void EditEnv::reset() {T=EditEnv();}
   void EditEnv::copyTo(Environment &dest, C Project &proj)C
   {
      dest=T;
   ...
   {
      TimeStamp bloom_saturate_time, bloom_contrast_time, bloom_half_time, bloom_maximum_time, bloom_blurs_time, clouds_ray_mask_contrast_time, sun_blend_time;
