...
if(full)
{
      ...
      if(scale_normal){scale_normal->display("Scale Normal"); scale_normal->moveValue(Vec2(0.09f, 0));}
      if(keep_uv     ){keep_uv     ->display("Keep UV"     ); keep_uv     ->moveValue(Vec2(0.09f, 0));}
      if(!full)
      {
