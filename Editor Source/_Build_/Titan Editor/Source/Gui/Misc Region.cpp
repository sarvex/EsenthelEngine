...
/******************************************************************************/
   ...
   void MiscRegion::ExportVS2022(MiscRegion &mr) {CodeEdit.Export(Edit::EXPORT_VS2022 );}
   ...
   void MiscRegion::PublishProjectPackage(MiscRegion &mr) {if(!PublishProjectPackageIO.is())PublishProjectPackageIO.create(ProjectPackageExt, S, SystemPath(SP_DESKTOP), null, PublishProjectPackageAs); PublishProjectPackageIO.save().name(CleanFileName(Proj.name));}
