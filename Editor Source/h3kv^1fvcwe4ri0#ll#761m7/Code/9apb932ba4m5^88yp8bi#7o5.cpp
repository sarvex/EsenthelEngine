...
class EditPhysMtrl
{
   flt           friction_static=1, friction_dynamic=1, bounciness=0.2, density=1, damping=0.05, adamping=0.05;
   PhysMtrl.MODE friction_mode=PhysMtrl.MODE_AVG, bounciness_mode=PhysMtrl.MODE_AVG;
