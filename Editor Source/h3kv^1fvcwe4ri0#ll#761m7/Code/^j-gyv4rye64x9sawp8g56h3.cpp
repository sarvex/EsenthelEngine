...
{
   static const LANG_TYPE Languages[]={EN, DE, LANG_DUTCH, FR, IT, SP, PO, PL, RU, JP, KO, CN, TH};
   enum ORIENT
   {
      ORIENT_PORTRAIT        ,
      ORIENT_LANDSCAPE       ,
   ...
   Property *p_icon=null, *p_image_portrait=null, *p_image_landscape=null, *p_notification_icon=null, *p_languages=null;
