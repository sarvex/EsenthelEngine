...
del "Project\*.pdb"
del "Project\*.log"
del "Editor Source\_Build_\Titan Editor\*.pdb"
...
rmdir /s /q "Editor Source\_Build_\Nintendo Switch - Precompile Shaders"
rmdir /s /q "Editor Source\_Build_\Titan Editor\.vs"
rmdir /s /q "Editor Source\_Build_\Titan Editor\Android"
