...
/******************************************************************************/
// Atomic operations
Byte AtomicInc(Byte &x); // increase value of 'x' by 1 in an atomic operation and return its previous value, this is a thread-safe version of function "return x++;" (this allows to modify the value across multiple threads without usage of Synchronization Locks)
...
Byte AtomicDec(Byte &x); // decrease value of 'x' by 1 in an atomic operation and return its previous value, this is a thread-safe version of function "return x--;" (this allows to modify the value across multiple threads without usage of Synchronization Locks)
...
Byte  AtomicAdd(Byte  &x, Byte  y); // increase value of 'x' by 'y' in an atomic operation and return its previous value, this is a thread-safe version of function "Int   old=x; x+=y; return old;" (this allows to modify the value across multiple threads without usage of Synchronization Locks)
...
UInt  AtomicAdd(UInt  &x, UInt  y); // increase value of 'x' by 'y' in an atomic operation and return its previous value, this is a thread-safe version of function "UInt  old=x; x+=y; return old;" (this allows to modify the value across multiple threads without usage of Synchronization Locks)
...
ULong AtomicAdd(ULong &x, ULong y); // increase value of 'x' by 'y' in an atomic operation and return its previous value, this is a thread-safe version of function "ULong old=x; x+=y; return old;" (this allows to modify the value across multiple threads without usage of Synchronization Locks)
Byte  AtomicSub(Byte  &x, Byte  y); // decrease value of 'x' by 'y' in an atomic operation and return its previous value, this is a thread-safe version of function "Int   old=x; x-=y; return old;" (this allows to modify the value across multiple threads without usage of Synchronization Locks)
...
UInt  AtomicSub(UInt  &x, UInt  y); // decrease value of 'x' by 'y' in an atomic operation and return its previous value, this is a thread-safe version of function "UInt  old=x; x-=y; return old;" (this allows to modify the value across multiple threads without usage of Synchronization Locks)
