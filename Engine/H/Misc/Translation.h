...
CChar* TAnime();
CChar* TApplicationLinkHasBeenCopiedToClipboard();
CChar* TApril();
CChar* TAprilShort();
CChar* TArachnids();
...
CChar* TAreYouSureYouWantToDeleteYourAccount();
...
CChar* TCollected();
CChar* TComics();
CChar* TCommentedOnYourPost(TRANS_FORM form=TF_NEUTRAL);
...
CChar* TLevel();
CChar* TLevels();
CChar* TLike(TRANS_FORM form=TF_NEUTRAL);
CChar* TLiked(TRANS_FORM form=TF_NEUTRAL);
CChar* TLikedYou(TRANS_FORM form=TF_NEUTRAL);
CChar* TLikedYourComment(TRANS_FORM form=TF_NEUTRAL);
CChar* TLikedYourPost(TRANS_FORM form=TF_NEUTRAL);
CChar* TLikes();
CChar* TLoading();
CChar* TLocked();
CChar* TLogIn();
...
CChar* TMentionedYou(TRANS_FORM form=TF_NEUTRAL);
CChar* TMenu();
CChar* TMessage();
CChar* TMiniMap();
CChar* TMods();
...
CChar* TProfile();
CChar* TProp();
CChar* TPublic(TRANS_FORM form=TF_NEUTRAL);
CChar* TPunch();
CChar* TPunchLeft();
CChar* TPunchRight();
...
CChar* TSharedYourPost(TRANS_FORM form=TF_NEUTRAL);
CChar* TSharpen();
CChar* TShield();
CChar* TShieldPotion();
CChar* TShop();
