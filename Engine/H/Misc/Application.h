...
struct Application // Application Settings
{
   ...
   void (*receive            )(File &f                                                ); // pointer to custom function called when a  file  is received [Supported Platforms: Android, iOS]
   void (*receive_image      )(Image &image                                           ); // pointer to custom function called when an image is received [Supported Platforms: Android, iOS]
 ...
 C Str&         backgroundText(               )C {return _back_text     ;} // get text displayed on the Status Bar Notification when App is running in Background mode on Android, default="Running in background"
   ...
   void pickPhoto(Int max_files); // open Photo Picker allowing to select 'max_files' number of images, they will be received through 'App.receive' or 'App.receive_image' callback [Supported Platforms: Android, iOS]
