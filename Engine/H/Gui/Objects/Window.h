...
const_mem_addr struct Window : GuiObj // Gui Window !! must be stored in constant memory address !!
{
   ...
   virtual Window& move      (C Vec2       &delta  )override;                                                                        //         move by delta
   virtual Window& rect      (C Rect       &rect   )override; C Rect&       rect          ()C {return super::rect()               ;} // set/get rectangle
   ...
   virtual Window& show      (       )override; // show
   virtual Window& hide      (       )override; // hide
