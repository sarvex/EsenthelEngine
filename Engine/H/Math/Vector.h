...
struct Vec2 // Vector 2D
{
   ...
   friend Vec2 operator* (C Vec2 &v, C Matrix2P &m) {return Vec2(v)*=m;}
...
struct VecD2 // Vector 2D (double precision)
{
   ...
   VecD2& operator*=(  Dbl       r) {x*=  r; y*=  r; return T;}
   VecD2& operator/=(  Dbl       r) {x/=  r; y/=  r; return T;}
   VecD2& operator+=(C Vec2     &v) {x+=v.x; y+=v.y; return T;}
   VecD2& operator-=(C Vec2     &v) {x-=v.x; y-=v.y; return T;}
   VecD2& operator*=(C Vec2     &v) {x*=v.x; y*=v.y; return T;}
   VecD2& operator/=(C Vec2     &v) {x/=v.x; y/=v.y; return T;}
...
struct VecD4 // Vector 4D (double precision)
{
   ...
   VecD4& operator*=(  Dbl    r) {x*=  r; y*=  r; z*=  r; w*=  r; return T;}
   VecD4& operator/=(  Dbl    r) {x/=  r; y/=  r; z/=  r; w/=  r; return T;}
   VecD4& operator+=(C Vec4  &v) {x+=v.x; y+=v.y; z+=v.z; w+=v.w; return T;}
   VecD4& operator-=(C Vec4  &v) {x-=v.x; y-=v.y; z-=v.z; w-=v.w; return T;}
   VecD4& operator*=(C Vec4  &v) {x*=v.x; y*=v.y; z*=v.z; w*=v.w; return T;}
   VecD4& operator/=(C Vec4  &v) {x/=v.x; y/=v.y; z/=v.z; w/=v.w; return T;}
...
Dbl Dist(C Vec2  &a, C VecD2 &b);
Dbl Dist(C VecD2 &a, C Vec2  &b);
...
Dbl Dist2(C Vec2  &a, C VecD2 &b);
Dbl Dist2(C VecD2 &a, C Vec2  &b);
