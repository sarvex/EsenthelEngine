...
void TransformByTerrainOrient(DIR_ENUM cube_face, Vec &dest, C Vec &src); // convert terrain vector 'src' to 'cube_face' terrain vector 'dest', same as "dest=src*Matrix3().setTerrainOrient(cube_face)"
