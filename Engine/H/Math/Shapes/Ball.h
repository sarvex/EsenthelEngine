...
DIR_ENUM DirToSphereTerrainPixel (C Vec &dir, Int res, Vec2 &xy); // convert vector direction (doesn't need to be normalized) to spherical cube face and terrain coordinates, 'res'=terrain    resolution, 'xy'=image pixel coordinates (0..res-1)
