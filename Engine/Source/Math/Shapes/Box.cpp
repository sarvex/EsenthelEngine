...
Box ::Box (C Capsule  &capsule) {if(capsule.isBall())set(capsule.ballR(), capsule.pos);else{Vec up=Abs(capsule.up)*capsule.innerHeightHalf()+capsule.r; min=capsule.pos-up; max=capsule.pos+up;}}
BoxD::BoxD(C CapsuleM &capsule) {if(capsule.isBall())set(capsule.ballR(), capsule.pos);else{Vec up=Abs(capsule.up)*capsule.innerHeightHalf()+capsule.r; min=capsule.pos-up; max=capsule.pos+up;}}
