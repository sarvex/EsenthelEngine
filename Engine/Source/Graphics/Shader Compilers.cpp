...
#ifdef HDR
{
   ...
   REPD(dither, 2)src.New("AdaptEye", "AdaptEye_VS", "AdaptEye_PS")("DITHER", dither);
}
#endif
...
#ifdef MOTION_BLUR
{
   ...
   const Int dilate_ranges[]={1, 2, 3, 4, 6, 8, 10, 12, 16, 20}; ASSERT(Elms(dilate_ranges)==Elms(Mtn.Dilates)); // #MotionBlurDilateRanges
