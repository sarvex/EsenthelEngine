...
{
   if(dest.hwType()==IMAGE_ASTC_4x4      || dest.hwType()==IMAGE_ASTC_5x4      || dest.hwType()==IMAGE_ASTC_5x5      || dest.hwType()==IMAGE_ASTC_6x5      || dest.hwType()==IMAGE_ASTC_6x6      || dest.hwType()==IMAGE_ASTC_8x5      || dest.hwType()==IMAGE_ASTC_8x6      || dest.hwType()==IMAGE_ASTC_8x8
   || dest.hwType()==IMAGE_ASTC_4x4_SRGB || dest.hwType()==IMAGE_ASTC_5x4_SRGB || dest.hwType()==IMAGE_ASTC_5x5_SRGB || dest.hwType()==IMAGE_ASTC_6x5_SRGB || dest.hwType()==IMAGE_ASTC_6x6_SRGB || dest.hwType()==IMAGE_ASTC_8x5_SRGB || dest.hwType()==IMAGE_ASTC_8x6_SRGB || dest.hwType()==IMAGE_ASTC_8x8_SRGB)
   {
