...
/*#if DEBUG
   ...
   void build(MeshBase &mshb, MESH_FLAG flag)
   {
...
/******************************************************************************/
void ClipMesh(C MeshBase &src, C Matrix *matrix, MeshBase &dest, C Plane *clip_plane, Int clip_planes, MESH_FLAG flag_and, Flt weld_pos_eps)
{
   flag_and&=src.flag();
...
/******************************************************************************/
void SplitMeshSolid(C Mesh &src, C Matrix *matrix, Mesh &dest_positive, Mesh &dest_negative, C Plane &clip_plane, C MaterialPtr &material, Flt tex_scale, MESH_FLAG flag_and, Flt weld_pos_eps)
{
