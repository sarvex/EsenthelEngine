...
APP_ABI      := arm64-v8a # armeabi-v7a x86 # "armeabi"=32-bit ARMV5 (older devices + emulator 2.3), "armeabi-v7a"=32-bit ARMV7 (newer devices + emulator 4.0), "arm64-v8a"=64-bit ARM, "x86"=32-bit x86
APP_STL      := c++_static
APP_MODULES  := Engine # this will force generation of .a lib
